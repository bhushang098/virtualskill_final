...
public class TeamDetailsPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadPrefs();
        setUi();
        chatItemAdapter = new ChatItemAdapter(detailedChatList,this,String.valueOf(user.getId()));
        Gson json = new Gson();
        ...
        cvChat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                inflateDetailedMessage(detailedChatList,Integer.parseInt(teamId),teamObj.getName());
                getChatMessages();
            }
        });
...
//                shimmerFrameLayout.setVisibility(View.GONE);
    ...
    private void sendmessage(String message, String teamId,PopupWindow popuseWindow) {

        Call <Map> call = RetrifitClient.getInstance().getChatApi()
                .sendChatMess(token,"team",message,teamId,"1");
