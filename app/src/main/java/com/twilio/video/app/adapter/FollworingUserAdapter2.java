...
public class FollworingUserAdapter2 extends RecyclerView.Adapter<FollworingUserAdapter2.FollworingUserAdapterViewHolder2>{

    List<FollowingList>  userList;
    Context context;
    String token;

    public FollworingUserAdapter2(List<FollowingList> userList, Context context, String token) {
    ...
    @NonNull
    @Override
    public FollworingUserAdapterViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());

        View view = inflater.inflate(R.layout.main_user_item,parent,false);
        return new FollworingUserAdapter2.FollworingUserAdapterViewHolder2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FollworingUserAdapterViewHolder2 holder, int position) {
